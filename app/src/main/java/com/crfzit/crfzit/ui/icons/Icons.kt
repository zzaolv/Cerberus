...
// 使用一个单例对象来组织我们手动导入的所有图标
object AppIcons {

    // --- Manually imported from androidx.compose.material.icons.filled ---

    val Dashboard: ImageVector by lazy { materialIcon(name = "Filled.Dashboard") {
        materialPath {
            moveTo(3.0f, 13.0f)
    ...
    val Wifi: ImageVector by lazy { materialIcon(name = "Filled.Wifi") {
        materialPath {
            ...
            lineToRelative(2.0f, -2.0f)
            curveTo(16.93f, 2.93f, 7.07f, 2.93f, 1.0f, 9.0f)
            close()
            moveTo(9.0f, 17.0f)
            ...
            lineToRelative(2.0f, -2.0f)
            curveTo(15.14f, 9.14f, 8.86f, 9.14f, 5.0f, 13.0f)
            close()
        }
    } }

    val Tune: ImageVector by lazy { materialIcon(name = "Filled.Tune") {
        materialPath {
            moveTo(3.0f, 17.0f)
            verticalLineToRelative(2.0f)
            horizontalLineToRelative(6.0f)
    ...
    val Style: ImageVector by lazy { materialIcon(name = "Filled.Style") {
        materialPath {
            moveTo(2.53f, 19.65f)
    ...
    // --- Manually imported from androidx.compose.material.icons.automirrored.filled ---

    val ListAlt: ImageVector by lazy { materialIcon(name = "AutoMirrored.Filled.ListAlt") {
        materialPath {
            moveTo(19.0f, 5.0f)
            verticalLineTo(3.0f)
